 ...
 * @author Ekam
 */
public class cpassEmp extends javax.swing.JInternalFrame implements mycred{
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Re-write new Password");
        ...
        try
            {
                ...
                try
                {
                    String p="select * from employeetable where username=?";
                    ...
                    if(mres.next())
                    {
                        ...
                        {    
                            ...
                            if(jPasswordField2.getText().equals(jPasswordField3.getText()))
                            {
                                ...
                                String q="update employeetable set password=? where username=?";
